...
nets = [nb.NubeamNet(ds, early_stopping=False, n_nn=8, learning_rate_init=0.001, hidden_layer_sizes=sizes,              ensemble_exclude_fraction=0.2, X_scalars = X_scalars, y_scalars=y_scalars, X_n_keep = X_n_keep, y_n_keep=y_n_keep, X_profiles = X_profiles, y_profiles=y_profiles) for sizes in [(25,25),(50,50),(75,75), (100,100),(150,150),(200,200),(250,250), (300,300)]] #update parameters, list of sizesfor j, net in enumerate(nets):
